...
/* Active-HIGH PSX button mask associated with one SDL key-down event. Used by
 * the frontend edge latch so a short host key tap cannot fall entirely between
 * guest pad polls. The default Return binding also accepts keypad Enter. */
