...
def load(config_path) -> AuditConfig:
    ...
    # Some tracked game configs are UTF-8 with a BOM (notably Tomba's).
    # tomllib.load() rejects that marker, so decode with utf-8-sig before
    # parsing. This accepts both BOM and ordinary UTF-8 without changing the
    # TOML semantics.
