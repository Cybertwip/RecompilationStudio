...
enum class InstrFormat {
    ...
    COP0,     // Coprocessor 0
    COP1,     // Absent PS1 coprocessor (trap/NOP-like semantics)
...
struct DecodedInstruction {
    ...
    bool is_load;           // LB/LH/LW/LBU/LHU/LWL/LWR/LWC1/LWC2
    bool is_store;          // SB/SH/SW/SWL/SWR/SWC1/SWC2
...
private:
    ...
    static void decode_cop1(DecodedInstruction& out);
